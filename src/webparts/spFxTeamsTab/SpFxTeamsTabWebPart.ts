...
import SpFxTeamsTab from './components/SpFxTeamsTab';
import { ISpFxTeamsTabProps } from './components/ISpFxTeamsTabProps';
...
export default class SpFxTeamsTabWebPart extends BaseClientSideWebPart<ISpFxTeamsTabWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<ISpFxTeamsTabProps> = React.createElement(
      SpFxTeamsTab,
      {
